        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem className="p-0">
                    {label && <FormLabel className="m-0 p-0 text-sm font-bold">{label}</FormLabel>}
                    ...
                    <div className="relative flex items-center">
                        ...
                        {isPasswordField && (
                            <button 
                                ...
                                {showPassword ? <EyeOff size={18} className="transition-all duration-500"/> : <Eye size={18} className="transition-all duration-500"/>}
                            </button>
                        )}
                    </div>
                    <div className="relative">
                        <FormMessage  className="absolute right-1/2"/>
                    </div>
                </FormItem>
            )}
        />
